    ...
    return(
        ...
        <section id="tile_left" onClick={() => navigate(contentsObj.knowMoreLink)} className="single-horizontal-tile" 
            ...
            <section className="mahasamvit-edu-faculty-details">
                ...
                <section className="mahasamvit-edu-faculty-action">{knowMoreSection.isSectionVisible && knowMoreSection.component && <knowMoreSection.component marginLeft={"50%"}/>}</section>
            </section>
        </section>
    )
}
