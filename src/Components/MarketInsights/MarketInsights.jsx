  ...
  <section className="course-syllabus-modules">
    <section className="insights-article-big-image">
      ...
      <section className="insights-main-heading-section">
        ...
        {knowMoreSection.isSectionVisible && <Link Link to={item.link} className="insights-read-more shrink-underline-black">Read More</Link>}
      </section>
    </section>
       ...
       {item.subModules.map((subItem, index) => 
         (<><section className="insights-article-image-container">
          ...
          <section className="insights-heading-section">
            ...
            {knowMoreSection.isSectionVisible && <Link to={item.link} className="insights-read-more shrink-underline-black">Read More</Link>}
          </section>
